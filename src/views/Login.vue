            ...
            <div class="col-6 loginForm">
                ...
                <Form v-slot="{ errors }" @submit.prevent="">
                    <div class="inputArea">
                        ...
                        <Field id="userID" name="userID" type="text" label="帳號" :class="{ 'is-invalid': errors['userID'] }"
                            placeholder="請輸入手機號碼或電子信箱" rules="required">
                        </Field>
                    ...
                    <div class="inputArea">
                        ...
                        <error-message name="userPW" class="invalid-feedback"></error-message>
                    </div>
            ...
            <div class="col-6 registerForm">
                ...
                <div class="terms">
                    ...
                    <ol>
                        ...
                        <li>
                            會員須善盡帳號及密碼的使用與管理之責任。對於使用該會員之帳號及密碼(無關於會員本身或其他人)
                            利用本站服務所造成或衍生之所有行為及結果，會員須自行負擔全部責任。
                        </li>
                        <li>
                            會員之帳號及密碼遺失，或發現無故遭第三者盜用時，應立即通知本站連絡掛失，因未即時通知，
